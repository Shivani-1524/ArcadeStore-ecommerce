            ...
            <div className="nav-icon-items">
                ...
                <Link to='/wishlist'>
                    <button id="dark-bg-icon" className="btn icon-btn pos-rel hide-md">
                        ...
                        {isLoggedIn && wishlistItems?.length > 0 && <div className="badge num-badge center-items">
                            <p className="xsm-title">{wishlistItems.length > 9 ? '9+' : wishlistItems.length}</p>
                        </div>}
                    </button>
                </Link>
                <Link to='/cart'>
                    <button id="dark-bg-icon" className="btn icon-btn pos-rel hide-md">
                        ...
                        {isLoggedIn && cartItems.length > 0 && <div className="badge num-badge center-items">
                            <p className="xsm-title">{cartItems.length > 9 ? '9+' : cartItems.length}</p>
                        </div>}
                    </button>
                </Link>
